...
from .datasets.image_mask import ImageMaskDataset
from .collectors.image_mask import from_image_mask_json
...
class OwlDataLoader:
    ...
    def __init__(self,
                 dataset_paths: list[str | pathlib.Path],
        ...
        self.datasets_map: dict[str, ImageMaskDataset] = {}
        self._init_datasets(dataset_paths)

    def _init_datasets(self, dataset_paths: list[str | pathlib.Path]):
        for p in dataset_paths:
            ...
            dataset = ImageMaskDataset(
                root_dir=path,
                collector_fn=from_image_mask_json,
    ...
    def __str__(self) -> str:
        return (
            ...
            f"dataset_paths={self.dataset_paths!r}, "
            f"dataloader_config={self.config!r}, "
            f"aug_configs={self.aug_configs!r}, "
