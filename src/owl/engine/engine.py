...
from .._monitor.snapshot import MonitorSnapshot
...
class OwlEngine(StateMachine):
    ...
    def __init__(
        ...
        monitor_ring: MonitorRing | None = None,
    ):
        ...
        # monitor
        self.monitor_ring: MonitorRing | None = monitor_ring
    ...
    def _emit_monitor_snapshot(
        ...
        if self.monitor_ring is None:
            return

        metrics = (step_result or {}).get("metrics", {})
        ...
        self.monitor_ring.append(snapshot)
