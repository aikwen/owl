...
from owl.toolkits.criterion.types import CriterionReturn
from owl.toolkits.data import types
...
from owl.toolkits.model.types import ModelOutput, ModelReturn
from owl.toolkits.data.augment.types import (
    ResizeConfig,
    HFlipConfig,
    VFlipConfig,
    RotateConfig,
...
def main():
    ...
    common_aug = [
        ResizeConfig(height=512, width=512, p=1.0)
    ]
    ...
    train_aug = [
        ...
        VFlipConfig(p=0.6),
        RotateConfig(p=0.6),
        JpegConfig(p=0.3, quality_low=50, quality_high=100),
        GblurConfig(p=0.3, kernel_low=1, kernel_high=7),
        ResizeConfig(height=512, width=512, p=1.0)
    ]
